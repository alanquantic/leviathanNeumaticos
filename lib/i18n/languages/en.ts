...
export const en: TranslationKeys = {
  ...
  analysisResults: {
    ...
    dataValues: {
      ...
      contractLoi: 'LETTER OF INTENT',
      contractSigned: 'SIGNED',
      // Verdict
      verdictViable: 'Viable',
      verdictNotViable: 'Not viable',
      verdictConditional: 'Viable with adjustments',
      // Tokenization Level
      tokenNotTokenizable: 'Not tokenizable',
      tokenWithChanges: 'Tokenizable with changes',
      tokenAsRwa: 'Tokenizable as RWA',
    },
  },
